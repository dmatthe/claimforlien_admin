  ...
  <body class="container-fluid">
    ...
    <nav is="cotui-tabs" data-selected="0" class="myClassName">
      <ul>
        ...
        <li data-target="bacon-ipsum">Bacon Ipsum</li>
        <li data-target="cat-ipsum">Cat Ipsum</li>
      </ul>
    </nav>
    <div id="riker-ipsum">
      <h2>Riker Ipsum</h2>
    ...
    <div id="bacon-ipsum">
      <h2>Bacon Ipsum</h2>
      <p>Bacon ipsum dolor amet tail pork loin shankle tenderloin picanha. Leberkas porchetta beef landjaeger turkey. Pancetta beef pig, flank turducken short loin corned beef sirloin. Beef chicken ground round spare ribs. Fatback burgdoggen boudin jerky pork chop.</p>
    </div>
    <div id="cat-ipsum">
      <h2>Cat Ipsum</h2>
      <p>Scream for no reason at 4 am scratch. Cats are fats i like to pets them they like to meow back jump five feet high and sideways when a shadow moves trip owner up in kitchen i want food. Cat slap dog in face. Mewl for food at 4am scratch the furniture my cat stared at me he was sipping his tea, too for that box? i can fit in that box. Really likes hummus prance along on top of the garden fence, annoy the neighbor's dog and make it bark. Eat from dog's food kitty run to human with blood on mouth from frenzied attack on poor innocent mouse, don't i look cute? damn that dog yet why must they do that demand to be let outside at once, and expect owner to wait for me as i think about it or drool, when in doubt, wash.</p>
    </div>
