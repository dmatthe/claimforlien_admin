...
<html lang="en">
  <head>
    ...
    <title>COTUI.Autosuggest</title>
  <link href="../cotui.min.css" rel="stylesheet"></head>
    <body class="container-fluid">

      <div id="app">
        <h2>JSON.Endpoint</h2>
        <cotui-autosuggest label="Find Address or Intersection (cotgeocoder)" limit="10" icon="fas fa-map-marker-alt" button="Lookup" type="api" data-api.attr-value="KEYSTRING" data-api.attr-text="ADDRESS" data-api.attr-array="result.rows" data-api.url="https://map.toronto.ca/cotgeocoder/rest/geocoder/suggest?f=json&addressOnly=0&retRowLimit=100&searchString={QUERY}" on-selected="handleSelected" on-results="handleResults" on-submit="handleSubmit"></cotui-autosuggest>

        <h2>Custom Search Handler</h2>
        <cotui-autosuggest label="Type username" icon="glyphicon glyphicon-user" button="Lookup" type="custom" on-search="handleSearch" on-selected="handleSelected" on-results="handleResults" on-submit="handleSubmit"></cotui-autosuggest>

        <h2>UL List</h2>
        <cotui-autosuggest limit="7" on-selected="handleSelected" on-results="handleResults" on-submit="handleSubmit">
          <ul>
    ...
    <script>
      ...
      document.onreadystatechange = function () {
        if (document.readyState == "interactive") {
          ...
          var autosuggestJSON = ui.Autosuggest({
            target:'#js-app',
            label:'Find Address or Intersection',
            button:'Lookup',
            icon:'glyphicon glyphicon-map-marker',
  ...
  <script type="text/javascript" src="../cotui.min.js"></script></body>
</html>
