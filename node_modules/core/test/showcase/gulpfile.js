...
const core = require('./showcase_gulp_helper');
...
let options = {
  ...
  deploymentPath: '/webapps/corejs/showcase'
  //.env file example path: DEV_DEPLOY_PATH=/Volumes/inet-1/insideto-secure/docs/webapps/corejs/showcase
};
