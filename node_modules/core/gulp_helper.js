...
const GulpHelper = {
      ...
      gulp.task('build_with_simulator', ['build'], () => {
        ...
        function staticStream() {
          ...
          if (options['config']['isEmbedded'] === false && options['config']['isInternetStandaloneApp'] === false) {
            src = fs.existsSync('cframe.html') ? 'cframe.html' : 'node_modules/core/dist/html/cframe_intranet.html';
          } else {
            src = fs.existsSync('cframe.html') ? 'cframe.html' : 'node_modules/core/dist/html/cframe.html';
          }
        ...
        return processSimulatorSrc(!isEmbeddedApp ? staticStream() : remoteSrc(['cframe/'], {
          ...
          processSimulatorSrc(gulp.src('./node_modules/core/dist/html/default_simulator.html')
            .pipe(useref({newLine: '\n\n', searchPath: ['.']})));
          //noinspection JSUnresolvedFunction
          this.emit('end');
        }));
  ...
  inject: (gulp, inject, stream, options) => {
    ...
    coreFiles = coreFiles.concat([ './node_modules/core/dist/js/jquery.cookie.adapter.js'])
    ...
    if (options['includeFormValidation']) {
      ...
      coreFiles = coreFiles.concat([
        "./node_modules/core/dist/js/formValidation.min.js",
        "./node_modules/core/dist/js/cot_forms.js",
        "./node_modules/core/dist/css/formValidation.min.css"
      ]);
      if (options['isEmbedded'] || options['includeLogin']) {
        coreFiles = coreFiles.concat([
          './node_modules/core/dist/css/embedded_cot_forms.css'
        ]);
      }
    }
    ...
    if (options['includeMultiSelect']) {
      ...
      coreFiles = coreFiles.concat([
        './node_modules/core/dist/js/lib/bootstrap-multiselect/dist/js/bootstrap-multiselect.js',
        './node_modules/core/dist/js/cot_multiselect.js',
        './node_modules/core/dist/css/bootstrap-multiselect.css'
      ]);
    }
    ...
    if (options['includeLogin']) {
      ...
      coreFiles = coreFiles.concat(['./node_modules/core/dist/js/cot_login.js']);
    }
    ...
    if (options['includeMap']) {
      ...
      coreFiles = coreFiles.concat([
        ...
        './node_modules/core/dist/css/cot_map.css',
        './node_modules/leaflet/dist/leaflet.js',
        './node_modules/esri-leaflet/dist/esri-leaflet-debug.js',
        './node_modules/leaflet.markercluster/dist/leaflet.markercluster-src.js',
        './node_modules/core/dist/js/lib/esri-leaflet-vector/esri-leaflet-vector-debug.js',
        ...
        './node_modules/core/dist/js/cot_map.js'
      ]);
    }
    if (options['isEmbedded']) {
      coreFiles = coreFiles.concat([
        './node_modules/core/dist/js/embedded_cot_app.js'
      ]);
    } else {
      coreFiles = coreFiles.concat([
        './node_modules/core/dist/js/cot_app.js',
        './node_modules/core/dist/css/cot_app.css'
      ]);
    }

    coreFiles = coreFiles.concat(['./node_modules/core/dist/css/cot_dropzone.css']);

    if (!options['isEmbedded']) {
      process.stdout.write('Core gulp helper injecting CoT UI\n');
      coreFiles.push('./node_modules/cotui/dist/cotui.js', './node_modules/cotui/dist/cotui.css');
    }
  ...
  distExtras: (gulp, distDir, options) => {
    ...
    let imageSrcs = options['isEmbedded'] ? [] : ['./node_modules/core/dist/img/*'];
    if (options['includeIntlTelInput']) {
