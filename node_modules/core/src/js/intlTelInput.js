...
(function (factory) {
  ...
  Plugin.prototype = {
    ...
    _generateMarkup: function () {
      ...
      // this.telInput.parent().append($('<span id="'+this.telInput.attr('id')+'_label" class="sr-only"></span>'));
      // this.telInput.attr('aria-labelledby',this.telInput.attr('id')+'_label');
    ...
    _setFlag: function (countryCode) {
      ...
      var labelSpan = this.telInput.parent().parent().parent().find('label').find('span');
      var countryCodeLabel = this.telInput.parent().parent().parent().find('label').find('.sr-only');
      if(countryCodeLabel.length > 0) {
        countryCodeLabel.html('selected County Code ' + title);
      } else {
        $('<span class="sr-only">' + 'selected County Code ' + title + '<span>').insertAfter(labelSpan);
      }

      // $('#'+this.telInput.attr('id')+'_label').html('County Code '+ title);
