...
$(function () {
  (window['cot_app'] || window['CotApp']).addMultiselect = function (o) {
    ...
    $ms.find('button').attr({
      ...
      'aria-labelledby': options.$select.attr('id')+'_label' + ' ' +options.$select.attr('id')+'_btn', // options.ariaLabelledBy,
    ...
    $ms.find('ul').attr({
      'id': listId,
      'aria-labelledby': options.$select.attr('id')+'_label', //options.ariaLabelledBy || o.$select.attr('id'),
