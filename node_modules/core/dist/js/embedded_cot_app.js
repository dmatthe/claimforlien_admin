...
CotApp.prototype.loadAppContent = function (o) {
  var data = {},
      options = $.extend({
    keys: [],
    //an array of titles of API Content Snippets from WP
    tag: '',
    //a future option, where you can get multiple snippets with a single tag
  ...
  if (options.tag) {//TODO: grab all content for a given tag
  } else {
    var count = 0;
